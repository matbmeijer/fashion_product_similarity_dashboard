...
## Introduction
The .R module **Image Similarity Analysis** is a simple workflow to show an introductory starting point to identify product similarities solely based on a product image.
